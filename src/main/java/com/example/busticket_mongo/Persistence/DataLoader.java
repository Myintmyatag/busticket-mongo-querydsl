...
public class DataLoader implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        BusRoute mandalayYangon = new BusRoute(
                new Bus("JJ",BusStatus.MODERATE,Arrays.asList(
        ...
        BusRoute yangonMandalay = new BusRoute(
                new Bus("AungMyanmar",BusStatus.MODERATE,Arrays.asList(
                        new Seats("A1",SeatStatus.VACANT),
                        new Seats("A2",SeatStatus.VACANT),
                        new Seats("A3",SeatStatus.VACANT),
                        new Seats("A4",SeatStatus.VACANT),
        ...
        BusRoute yangonTaungyi = new BusRoute(
                new Bus("TT",BusStatus.MODERATE,Arrays.asList(
                        new Seats("A1",SeatStatus.VACANT),
                        new Seats("A2",SeatStatus.VACANT),
                        new Seats("A3",SeatStatus.VACANT),
                        new Seats("A4",SeatStatus.VACANT),
        ...
        Collection<BusRoute> busRoutes = Arrays.asList(mandalayYangon,yangonMandalay,yangonTaungyi);
